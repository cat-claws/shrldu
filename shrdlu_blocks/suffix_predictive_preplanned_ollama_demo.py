"""Natural-language GUI demo backed by a suffix predictive preplanned Ollama agent."""
...
def demo(model: str = DEFAULT_MODEL, host: str = 'http://127.0.0.1:11434',
    ...
    """Run the GUI demo with a suffix predictive preplanned Ollama agent."""
    pygame.init()
    ...
    viewer = Viewer(
        screen,
        "SHRDLU Blocks Suffix Predictive Preplanned Ollama Demo",
